...
P_intesity = pd.read_csv("./data/intensity.csv").values  # intensity MC
P_location = pd.read_csv("./data/location.csv").values  # location MC
P_landfall = pd.read_csv("./data/landfall_7.csv").values  # landfall MC
...
nodes = pd.read_csv("./data/nodes.csv")  # read the nodes locations
